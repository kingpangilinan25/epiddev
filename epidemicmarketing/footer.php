...
*/ ?>
		...
		<footer id="footer" role="contentinfo">
        	<div class="container">
                <div class="row">
                    <div class="col-sm-4 col-sm-push-4 cwidget-f cwf1">
                    	<?php footer_nav(); ?>
                    </div>
                    <div class="credit col-sm-4 col-sm-pull-4 cwidget-f cwf2"> 
                            ...
                            Copyright &copy; <?php echo date('Y'); ?> - <span class="hl-lb">Epidemic Marketing</span>                   
                    ...
                    <div class="col-sm-4 cwidget-f cwf3">      
                    	<p class="phone-f-cont">
                            <span class="title-pf">Call Us Now</span>
                            <a href="tel:3035866728"><span>303-586-6728</span></a>              
                        </p>
                        <p class="addr-cont-f">
                            <a target="_blank" href="https://www.google.com/maps/place/Epidemic+Marketing/@39.7137818,-106.0812237,8z/data=!3m1!4b1!4m2!3m1!1s0x876c7e9500f3f479:0x36879da2f9893699">
